  ...
  return (
    <div className='text-blue-600'>
        ...
        <div>
            ...
            <div>
           <Link to='loans' className=" md:text-lg mx-20 my-20 sm:text-lg text-lg hover:bg-gray-700 mt-10  bg-blue-950 px-6 py-6 text-white flex justify-center items-center">Learn more </Link>
        </div>
        </div>
    </div>
    </div>
