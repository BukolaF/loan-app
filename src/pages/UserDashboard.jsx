...
export const UserDashboard = () => {
  ...
  return (
   <div className='flex'>
    <div className={classNames("bg-blue-950 text-gray-600 shadow-xl z-[999] w-[20rem] max-w-[20rem] h-screen overflow-hidden md:relative", {opennav: "w-[20rem]", "w-[6rem]":!opennav})}>
